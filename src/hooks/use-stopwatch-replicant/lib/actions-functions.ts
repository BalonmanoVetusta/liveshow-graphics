...
function sendStopwatchMessage(
  ...
  payload: StopwatchActionPayloadType | Partial<StartActionType["payload"]> = undefined,
...
export const start = (payload: StartActionType["payload"] | undefined = undefined) =>
  sendStopwatchMessage(StopwatchActions.START, payload);

export const stop = () => sendStopwatchMessage(StopwatchActions.STOP);

export const reset = (payload: Partial<StartActionType["payload"]> = undefined) =>
...
export const setBackwards = (payload: SetBackwardsActionType["payload"] | undefined = undefined) =>
